...
function mapU(n, f) {
  ...
  let newLeft = mapU(n.l, f);
  let newD = f(n.v);
  let newRight = mapU(n.r, f);
  return {
          k: n.k,
          v: newD,
          h: n.h,
...
function mapWithKeyU(n, f) {
  ...
  let key = n.k;
  let newLeft = mapWithKeyU(n.l, f);
  let newD = f(key, n.v);
  let newRight = mapWithKeyU(n.r, f);
  return {
          k: key,
          v: newD,
          h: n.h,
...
function keepSharedU(n, p) {
  ...
  let v = n.k;
  let d = n.v;
  let newLeft = keepSharedU(n.l, p);
  let pvd = p(v, d);
  let newRight = keepSharedU(n.r, p);
  if (pvd) {
...
function keepMapU(n, p) {
  ...
  let v = n.k;
  let d = n.v;
  let newLeft = keepMapU(n.l, p);
  let pvd = p(v, d);
  let newRight = keepMapU(n.r, p);
  if (pvd !== undefined) {
...
function partitionSharedU(n, p) {
  ...
  let key = n.k;
  let value = n.v;
  let match = partitionSharedU(n.l, p);
  let lf = match[1];
  let lt = match[0];
  let pvd = p(key, value);
  let match$1 = partitionSharedU(n.r, p);
  let rf = match$1[1];
  let rt = match$1[0];
  if (pvd) {
    return [
