...
let match = Caml_sys.sys_get_argv(undefined);

let os_type = Caml_sys.os_type(undefined);
...
let unix = Caml_sys.os_type(undefined) === "Unix";

let win32 = Caml_sys.os_type(undefined) === "Win32";
